...
# Base request schema for creating or updating a task.
...
public type TasksBody record {
    # Complete request payload for creating a new task with all available options.
...
# Request object for adding a task to a project with positioning options.
...
public type TaskBase record {
    *TaskCompact;
    ...
    # The user who assigned this task, or null if no specific assigner.
...
# Request payload specifying the project to remove a task from.
...
# User response with base information, profile photo URLs, and email address.
...
public type GoalGidAddFollowersBody record {
    # Request body specifying followers to add to a task or goal.
...
public type TeamSingleResponse record {
    # A complete team record with visibility, access controls, and organization details.
    TeamResponse data?;
};
...
public type ProjectResponse record {
    *ProjectBase;
    ...
    @jsondata:Name {value: "permalink_url"}
    string permalinkUrl?;
    # The user who marked this project as complete.
    @jsondata:Name {value: "completed_by"}
    UserCompact completedBy?;
};
...
public type TagCompactListResponse record {
    ...
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact tag objects returned by the request.
    TagCompact[] data?;
};
...
public type TeamResponse record {
    *TeamBase;
    ...
    # The organization or workspace to which the team belongs.
