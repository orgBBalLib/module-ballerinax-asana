...
public type TasksBody record {
    # Request body containing all properties required to create a new task.
...
# Response object containing a paginated list of compact section records.
public type SectionCompactListResponse record {
    ...
    NextPage? nextPage?;
    # An array of compact section objects returned by the query.
    SectionCompact[] data?;
};
...
public type TaskBase_external record {
    # Unique identifier for the external data record.
    string gid?;
    # Custom external data blob stored with the task.
    string data?;
};

# Base project status update with color, text, and HTML content.
...
# Request object specifying the project and position for adding a task.
...
public type ProjectCompactListResponse record {
    ...
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact project objects returned by the API.
    ProjectCompact[] data?;
};
...
# Response object containing a paginated list of compact story records.
public type StoryCompactListResponse record {
    # Pagination information for retrieving the next set of stories.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # An array of compact story objects returned by the query.
    StoryCompact[] data?;
};

# User response containing base info, profile photo URLs, and email address.
...
public type TeamSingleResponse record {
    # Complete team object with visibility settings, access controls, and organization details.
    TeamResponse data?;
};
...
# Response object containing a single section record with full details.
...
# Response object containing a single story record with full details.
public type StorySingleResponse record {
    # A complete story object with all details including changes, reactions, and related resources.
    StoryResponse data?;
};
...
public type StoryResponse record {
    *StoryBase;
    ...
    boolean hearted?;
    # The new section after a section change event.
    ...
    boolean isEdited?;
    # The new value of a date custom field in this story.
    ...
    Preview[] previews?;
    # The new enum option value for a custom field change.
