...
public type CustomFieldSettingResponse record {
    *CustomFieldSettingBase;
    ...
    # Deprecated: Use `parent` field. The project this custom field setting refers to.
...
public type TagSingleResponse record {
    # Complete tag object including workspace, followers, and metadata.
    TagResponse data?;
};
...
# Request object containing all fields required to create or update a project.
...
# Base custom field object with configuration properties for display and formatting.
...
# Request body for setting or changing a task's parent task.
public type TaskGidSetParentBody record {
    # Request object for setting or changing a task's parent.
...
# User response with base properties, profile photo, and email address.
...
# Response containing a list of tasks matching search criteria.
public type TaskSearchListResponse record {
    # Array of compact task objects matching the search query.
    TaskCompact[] data?;
};
...
# Full response object for a project status including author and timestamps.
...
# Response containing a paginated list of compact attachment objects.
public type AttachmentCompactListResponse record {
    # Pagination information for retrieving the next set of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
...
# Error object containing details about an API request failure.
...
public type StorySingleResponse record {
    # A complete story object with all activity details, values, and metadata.
    StoryResponse data?;
};
...
public type StoryResponse record {
    *StoryBase;
    ...
    boolean hearted?;
    # The new section value after the change.
    ...
    # The type of story, either a comment or system-generated event.
    "comment"|"system" 'type?;
