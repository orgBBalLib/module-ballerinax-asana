...
# A paginated response containing compact workspace records with navigation support.
public type WorkspaceCompactPagedResponse record {
    # Pagination information for retrieving the next set of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact workspace records.
...
# Paginated response containing an array of compact tag objects.
public type TagCompactPagedResponse record {
...
# Complete task object with full details including relationships and custom fields.
...
# Request object specifying project and position details for adding a task.
...
# Base project object containing core properties, settings, and metadata.
...
# Complete custom field data including values, access settings, and metadata.
...
# Base task schema containing detailed task properties and metadata.
...
# Paginated response containing a list of compact project objects.
public type ProjectCompactPagedResponse record {
    # Pagination information for retrieving the next set of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact project objects in the current page.
    ProjectCompact[] data?;
};
...
# Paginated response containing compact team records with pagination support.
public type TeamCompactPagedResponse record {
    # Pagination information for retrieving the next page of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
...
# Paginated response containing an array of compact story objects.
public type StoryCompactPagedResponse record {
    # Pagination information for retrieving the next set of stories.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact story objects returned in the response.
    StoryCompact[] data?;
};
...
public type TeamSingleResponse record {
    # A complete team object with visibility settings, access controls, and organization details.
    TeamResponse data?;
};

# A response object containing a single workspace record.
...
# A complete project status record including author and timestamp metadata.
...
public type UserCompactPagedResponse record {
    # Pagination information for retrieving the next page of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact user objects returned by the request.
    UserCompact[] data?;
};
...
# Paginated response containing an array of compact task objects.
public type TaskCompactPagedResponse record {
    # Pagination information for retrieving the next page of results.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
...
# Response object containing a single section with full details.
...
# Error response containing help links, error phrase, and message details.
...
# Response object containing a single story with full details.
...
public type StoryResponse record {
    *StoryBase;
    ...
    boolean hearted?;
    # The new section the task was moved to.
