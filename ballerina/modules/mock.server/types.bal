...
public type TaskResponse record {
    *TaskBase;
    ...
    # The workspace this task belongs to. Set at creation, cannot be changed.
...
# Base project object containing core properties and settings.
...
# Complete custom field object with all properties and values returned from the API.
...
# Base custom field object with configuration properties for formatting and display.
...
# A full workspace object with organization status and email domain information.
...
# Response object containing a paginated list of project sections.
...
# Base task schema with full details including dates, status, and metadata.
...
# User response with base fields, profile photos, and email address.
...
public type ProjectsprojectGidBody record {
    # Request object containing fields to update on a project.
...
public type TeamSingleResponse record {
    # Full team details including visibility, access controls, and organization information.
    TeamResponse data?;
};
...
public type TaskListResponse record {
    ...
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of task objects returned by the query.
    TaskCompact[] data?;
};
...
# Response object containing a single section's complete details.
...
# Response object containing a single story's complete details.
public type StorySingleResponse record {
    # Complete story object with all activity details, reactions, and change tracking.
    StoryResponse data?;
};
