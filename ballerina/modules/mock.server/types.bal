...
# Request to insert a task into a specific position within a section.
...
public type TasksBody record {
    # Request body containing all properties needed to create a new task.
...
# Response object containing a single tag.
...
# Full representation of a task including relationships, custom fields, and metadata.
...
public type TaskBase_external record {
    # Unique identifier for the external data reference.
    string gid?;
    # Custom external data blob stored with the task.
    string data?;
};
...
# Request object for adding a task to a project with optional positioning.
...
public type TagsBody record {
    # Request object for creating a new tag with workspace and followers.
...
# Complete custom field object with all properties including values and metadata.
...
# A full workspace object containing organization status and email domains.
...
# Response object containing a paginated list of compact team records.
...
# Response wrapper containing a list of compact project resources with pagination.
...
# User response with profile photo URLs and email address.
...
# Base tag schema combining compact fields with notes and color properties.
...
public type ErrorResponse record {
    # Array of error objects containing details about the request failure.
    Error[] errors?;
};
...
# Response wrapper containing a paginated list of compact user objects.
...
# Response wrapper containing a single project resource.
public type ProjectSingleResponse record {
    # Complete project object returned by the API with all available fields.
...
# Response object containing a single team.
public type TeamSingleResponse record {
    # Complete team information including visibility, access controls, and organization details.
    TeamResponse data?;
};
...
# Response object containing a single task.
...
# Request body wrapper for adding a task to a section.
...
public type TagCompactListResponse record {
    ...
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
    # Array of compact tag objects returned by the query.
    TagCompact[] data?;
};
...
public type TeamResponse record {
    *TeamBase;
    ...
    # The organization or workspace that the team belongs to.
...
# Error object containing details about a failed API request.
...
public type StorySingleResponse record {
    # Complete representation of a story including change tracking and interaction data.
    StoryResponse data?;
};
...
public type StoryResponse record {
    *StoryBase;
    ...
    # The previous date range values before the change.
    ...
    # The previous section before a task was moved.
