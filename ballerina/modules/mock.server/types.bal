...
public type TaskResponse record {
    *TaskBase;
    ...
    # The workspace this task belongs to; set at creation only.
...
# Base project object with core properties including dates, settings, and status.
...
# Response containing a paginated list of project sections.
...
# Base task schema with detailed properties including dates, status, and metadata.
...
# Response containing a paginated list of stories.
...
# Base tag schema with compact properties, notes, and color configuration.
...
public type ErrorResponse record {
    # Array of error objects containing details about the failure.
    Error[] errors?;
};
...
public type ProjectSingleResponse record {
    # Complete project object returned from API responses with all details.
...
# Request body wrapper for creating or updating a team.
...
public type TeamSingleResponse record {
    # A complete team object with visibility settings, permissions, and organization details.
    TeamResponse data?;
};
...
# A complete project status update with author and timestamp information.
...
# Response containing a single section object.
...
# Response containing a single story object.
public type StorySingleResponse record {
    # A complete story object with full details including change tracking and reactions.
    StoryResponse data?;
};
...
# Complete user object with base properties, custom fields, and workspace access.
...
public type StoryResponse record {
    *StoryBase;
    ...
    string? newName?;
    # The custom field that was changed in this story.
    @jsondata:Name {value: "custom_field"}
...
# Response containing a single user's complete details.
