...
# Complete project portfolio setting with creation timestamp and compact details.
...
# Complete rate information extending compact rate details.
...
# Base project status with color and text.
...
# Request object for adding a supporting resource to a parent goal.
public type GoalAddSupportingRelationshipRequest record {
    ...
    @jsondata:Name {value: "contribution_weight"}
    decimal contributionWeight?;
    # An id of an insert target for ordering the supporting relationship
...
# Compact timesheet approval status.
...
# Request to remove a supporting relationship from a parent goal.
...
# Filter criteria for webhook request subscriptions.
...
public type WebhookListResponse record {
    # Pagination information for retrieving the next page of webhooks.
    @jsondata:Name {value: "next_page"}
    NextPage? nextPage?;
...
public type RuleTriggerResponse record {
    # The message indicating the result of the rule trigger
    string message?;
};
...
public type WebhookUpdateRequestFilters record {
    # The resource subtype filter for webhook updates
    @jsondata:Name {value: "resource_subtype"}
    string resourceSubtype?;
    # The action filter for webhook updates
    string action?;
    # The fields filter for webhook updates
    string[] fields?;
    # The resource type filter for webhook updates
    @jsondata:Name {value: "resource_type"}
    string resourceType?;
};
