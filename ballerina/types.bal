...
# Complete project portfolio setting with creation timestamp and configuration details.
...
# Compact representation of a rate
...
# Complete rate information returned from the API.
...
# Base team record with core team properties.
...
# Request payload for creating or updating a team with access controls.
...
# Request object for adding a supporting resource to a goal.
public type GoalAddSupportingRelationshipRequest record {
    ...
    @jsondata:Name {value: "contribution_weight"}
    decimal contributionWeight?;
    # An id of an insert target. The supporting resource will be inserted before the target
    @jsondata:Name {value: "insert_before"}
    string insertBefore?;
    # An id of an insert target. The supporting resource will be inserted after the target
...
# Polymorphic membership response for various Asana resource types.
...
# Base portfolio record with core properties.
...
public type CustomFieldSettingResponse record {
    ...
    @jsondata:Name {value: "resource_type"}
    string resourceType?;
    # Whether this custom field is important
...
# Complete portfolio details including members, custom fields, and status information.
...
public type WebhookRequestFilters record {
    # The type of the resource for filtering
    @jsondata:Name {value: "resource_type"}
    string resourceType?;
    # The resource subtype for filtering
    @jsondata:Name {value: "resource_subtype"}
    string resourceSubtype?;
    # The action for filtering
    string action?;
...
# Base tag record with core properties.
...
# A compact representation of a webhook
...
# Base RBAC role record with core properties.
...
# A compact representation of a timesheet approval status
...
public type CustomFieldCompact record {
    ...
    string? textValue?;
    # *Conditional*. A string representation for the value of the custom field
    string 'type?;
    ...
    record {
        # The date component of the date value
        string date?;
        # The datetime component of the date value
    ...
    # The enum value for the custom field
    ...
    # The multi enum values for the custom field
