...
# Full response object for a rate resource.
...
public type GoalAddSupportingRelationshipRequest record {
    ...
    @jsondata:Name {value: "contribution_weight"}
    decimal contributionWeight?;
    # An id of an insert target used to re-order the supporting relationships
...
# Membership response for goals, projects, portfolios, or custom types.
...
# Custom field setting response with field details.
...
public type PortfolioResponse record {
    *PortfolioBase;
    ...
    # The latest status update posted to this portfolio.
...
public type WebhookRequestFilters record {
    ...
    @jsondata:Name {value: "resource_subtype"}
    string resourceSubtype?;
    # A set of field names to filter results
    string[] fields?;
};

# Request object for creating a new webhook subscription with resource, target URL, and filters.
...
# A batch request action.
public type BatchRequestAction record {
    # The path of the request relative to the API's base URL
    @jsondata:Name {value: "relative_path"}
    string relativePath;
    # The HTTP method for the request
    "get"|"post"|"put"|"delete"|"patch" method;
    # For GET requests, this should be a map of query parameters to values. For POST, PATCH, and PUT methods, this should be the content to be sent in the body
    record {} data?;
...
# Compact representation of a webhook.
...
public type CustomFieldCreateRequest record {
    ...
    # The type of the custom field
    @jsondata:Name {value: "resource_subtype"}
    "text"|"enum"|"multi_enum"|"number"|"date"|"people"|"formula"|"custom_id" resourceSubtype;
...
# Compact representation of a project membership.
...
# Compact project membership object with resource type and subtype information.
...
# Request object for updating an RBAC role.
...
# Full response object representing a goal relationship.
